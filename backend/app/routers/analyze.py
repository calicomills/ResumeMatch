...
async def analyze(
    ...
    jd_full_text, _jd_hidden_spans, _ = await resolve_text("job description", jd_text, jd_file)
    ...
    resume_full_text, hidden_spans, hidden_text_checked = await resolve_text(
